...
public class DeleteRequest extends AsyncTask<String, Void, String> {
        ...
        public DeleteRequest (String url, String json) {
            this.url = url;
            this.json = json;
        }

        public DeleteRequest(String url, String headerKey, String headerValue) {
            this.url = url;
        ...
        public DeleteRequest (String url, String json, String key, String value) {
            this.url = url;
            this.json = json;
            this.key = key;
            this.value = value;
